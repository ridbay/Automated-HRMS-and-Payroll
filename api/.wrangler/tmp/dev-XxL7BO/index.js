...
var isRawRequest, parseBody, handleParsingAllValues, handleParsingNestedValues;
var init_body = __esm({
  "node_modules/hono/dist/utils/body.js"() {
    init_checked_fetch();
    init_modules_watch_stub();
...
var employees, emergencyContacts, employeesRelations, emergencyContactsRelations, employeeDocuments, employeeDocumentsRelations;
var init_employee_model = __esm({
  "src/models/employee.model.ts"() {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    ...
    emergencyContacts = sqliteTable("emergency_contacts", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
    ...
    employeesRelations = relations(employees, ({ many }) => ({
    ...
    employeeDocuments = sqliteTable("employee_documents", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
      employeeId: text("employee_id").notNull().references(() => employees.id),
      name: text("name").notNull(),
    ...
    employeeDocumentsRelations = relations(employeeDocuments, ({ one }) => ({
      employee: one(employees, {
...
var attendanceRecords, overtimeRequests;
var init_attendance_model = __esm({
  "src/models/attendance.model.ts"() {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    ...
    init_employee_model();
    init_company_model();
    attendanceRecords = sqliteTable("attendance_records", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
      employeeId: text("employee_id").notNull().references(() => employees.id),
    ...
    overtimeRequests = sqliteTable("overtime_requests", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
      employeeId: text("employee_id").notNull().references(() => employees.id),
      date: text("date").notNull(),
...
var leaveRequests, leaveBalances;
var init_leave_model = __esm({
  "src/models/leave.model.ts"() {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    ...
    init_employee_model();
    init_company_model();
    leaveRequests = sqliteTable("leave_requests", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
      employeeId: text("employee_id").notNull().references(() => employees.id),
      type: text("type").notNull(),
    ...
    leaveBalances = sqliteTable("leave_balances", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
      employeeId: text("employee_id").notNull().references(() => employees.id),
      type: text("type").notNull(),
...
var walletTransactions, jobRequisitions;
var init_misc_model = __esm({
  "src/models/misc.model.ts"() {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    ...
    jobRequisitions = sqliteTable("job_requisitions", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
...
var payrollRuns, payslips, payrollRunsRelations, payslipsRelations;
var init_payroll_model = __esm({
  "src/models/payroll.model.ts"() {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    ...
    init_company_model();
    init_employee_model();
    payrollRuns = sqliteTable("payroll_runs", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
    ...
    payrollRunsRelations = relations(payrollRuns, ({ many }) => ({
      payslips: many(payslips)
    }));
    payslipsRelations = relations(payslips, ({ one }) => ({
...
var init_settings_model = __esm({
  "src/models/settings.model.ts"() {
    ...
    companySettings = sqliteTable("company_settings", {
...
var init_org_model = __esm({
  "src/models/org.model.ts"() {
    ...
    init_drizzle_orm();
    init_company_model();
    departments = sqliteTable("departments", {
      id: text("id").primaryKey(),
      companyId: text("company_id").references(() => companies.id).notNull(),
      name: text("name").notNull(),
...
var employeeBenefits, employeeBenefitsRelations;
var init_benefits_model = __esm({
  "src/models/benefits.model.ts"() {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    ...
    init_company_model();
    init_employee_model();
    employeeBenefits = sqliteTable("employee_benefits", {
      id: text("id").primaryKey(),
      companyId: text("company_id").notNull().references(() => companies.id),
    ...
    employeeBenefitsRelations = relations(employeeBenefits, ({ one }) => ({
      employee: one(employees, {
...
var init_feedback_model = __esm({
  "src/models/feedback.model.ts"() {
    ...
    init_sqlite_core();
    init_drizzle_orm();
    feedbacks = sqliteTable("feedbacks", {
      id: text("id").primaryKey(),
...
var hashPassword, generateSalt, AuthService;
var init_auth_service = __esm({
  "src/services/auth.service.ts"() {
    ...
    init_employee_model();
    init_schema();
    hashPassword = /* @__PURE__ */ __name(async (password, salt) => {
...
var OrgService = class {
  ...
  async getDepartments(companyId) {
    return this.db.select().from(departments).where(eq(departments.companyId, companyId)).all();
  }
...
adminRoutes.get("/dev/seed", async (c) => {
  ...
  const { hashPassword: hashPassword2, generateSalt: generateSalt2 } = await Promise.resolve().then(() => (init_auth_service(), auth_service_exports));
  ...
  for (const u of users) {
    ...
    const hash = await hashPassword2("password123", salt);
...
adminRoutes.delete("/locations/:id", async (c) => {
  const companyId = c.get("companyId");
  const orgService = new OrgService(c.env.DB);
