...
const Benefits: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "summary" | "health" | "retirement" | "equity" | "wellness" | "enrollment"
  >("summary");
    ...
    <div className="space-y-8 pb-20">
        ...
        >
          ...
          <div className="flex-1 space-y-6 relative z-10">
            ...
            <p className="text-sm text-slate-500 font-medium leading-relaxed max-w-md">
              Your total compensation includes your base salary plus the market
              value of your health, retirement, and equity benefits.
            </p>
          </div>
        ...
        <div className="bg-slate-900 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-6 mb-10">
            ...
            <p className="text-xs text-indigo-100 font-medium leading-relaxed">
              You can still change your health and dental plans for the 2024
              period. Review your current enrollment.
            </p>
          </div>
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {MOCK_BENEFITS.map((benefit) => (
          ...
          >
            <div
              className={`w-14 h-14 bg-${benefit.color}-50 text-${benefit.color}-600 rounded-2xl flex items-center justify-center mb-6 shadow-inner group-hover:scale-110 transition-transform`}
            >
          ...
          <div className="bg-indigo-600 p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 text-xs font-bold text-indigo-100"
                >
        ...
        <div className="lg:col-span-2 space-y-10">
          <div className="bg-white p-12 rounded-[3.5rem] border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <h3 className="text-2xl font-black text-slate-800 mb-10 flex items-center gap-4">
              <PieChartIcon className="text-indigo-600" /> {compData?.benefits?.retirementPlan || '401(k) / Pension Plan'}
            </h3>
            ...
            <div className="grid grid-cols-2 gap-6 mb-10">
              <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                ...
                <div className="text-4xl font-black text-slate-800">
                  {new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(compData?.benefits?.retirementBalance || 0)}
                </div>
              </div>
              <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                <div className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">
                ...
                <div className="text-4xl font-black text-emerald-500">
                  {compData?.benefits?.retirementContributionRate || 0}%{" "}
                  <span className="text-base text-slate-400">/ paycheck</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 bg-indigo-50 border border-indigo-100 rounded-[2.5rem]">
              ...
              <p className="text-sm text-slate-600 font-medium">
                ZenHR matches 100% of your contributions up to {compData?.benefits?.employerMatchRate || 0}% of your
                salary.
              </p>
              <div className="mt-6 flex justify-end">
                <button className="px-6 py-3 bg-white text-indigo-600 font-black uppercase text-xs tracking-widest rounded-xl shadow-sm hover:shadow-md transition-all">
                  Change Contribution
                </button>
              </div>
            </div>
          ...
          <div className="bg-white p-10 rounded-[3.5rem] border border-slate-200 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-black text-slate-800">80%</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
            ...
            <button className="w-full mt-8 py-4 border-2 border-slate-100 text-slate-500 font-black uppercase tracking-widest text-xs rounded-2xl hover:border-slate-200 hover:text-slate-800 transition-colors">
              Manage Portfolio
            </button>
          </div>
        </div>
          ...
          <div className="bg-white p-12 rounded-[3.5rem] border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-8">
              {MOCK_CHALLENGES.map((challenge) => (
                <div
                  key={challenge.id}
                  className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 relative group"
                >
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium">
                        Ends in 8 days • {challenge.participants} members
                      </p>
                    </div>
                    <button
        ...
        <div className="space-y-10">
          <div className="bg-slate-900 p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="bg-white p-6 rounded-[2rem] flex items-center justify-center mb-8">
              ...
              <div className="text-5xl font-black text-slate-800 mb-4">
                  {new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(
                    (compData?.benefits?.wellnessBudget || 150000) - (compData?.benefits?.wellnessUsed || 0)
                  )}
              </div>
              <div className="w-full h-3 bg-white rounded-full overflow-hidden p-0.5 mb-2">
                  <div 
                    className="h-full bg-emerald-500 rounded-full" 
                    style={{ width: `${((compData?.benefits?.wellnessUsed || 0) / (compData?.benefits?.wellnessBudget || 150000)) * 100}%` }}
                  ></div>
              </div>
              <div className="text-xs font-bold text-slate-500 flex justify-between">
                  <span>Used: {new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(compData?.benefits?.wellnessUsed || 0)}</span>
                  <span>Total: {new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(compData?.benefits?.wellnessBudget || 150000)}</span>
              </div>
            </div>
            <div className="text-center">
              ...
              <button className="w-full mt-8 py-4 bg-indigo-600 text-white rounded-[1.5rem] font-black text-xs uppercase tracking-widest">
                Renew Access
              </button>
            </div>
          </div>
        ...
        <div className="bg-indigo-600 p-12 text-white flex justify-between items-start relative">
          ...
          <div>
            ...
            <p className="text-indigo-100 font-medium">
              Design your rewards package for the 2024 period.
            </p>
          </div>
        </div>
                ...
                <div className="space-y-10">
                  <div className="flex items-center gap-4 border-l-4 border-indigo-600 pl-6">
                    ...
                    <h3 className="text-xl font-black text-slate-800">
                      Step 1: Choose Your Health Plan
                    </h3>
                  </div>
                    ...
                    {[
                      {
                        name: "Standard PPO",
                        cost: "₦45,000/mo",
                        features: ["90% In-network", "₦50k Deductible"],
                        selected: false,
                      },
                      {
                        name: "Gold PPO (Recommended)",
                        cost: "₦80,000/mo",
                        features: [
                          "100% In-network",
                          "Zero Deductible",
                      ...
                      <div
                        ...
                        className={`p-8 rounded-[2.5rem] border-4 transition-all cursor-pointer ${
                          plan.selected
                            ? "border-indigo-600 bg-indigo-50/20 shadow-xl shadow-indigo-100"
                      ...
                      >
                        ...
                        <p className="text-indigo-600 font-black mb-6 uppercase text-xs tracking-widest">
                          {plan.cost} Cost
                        </p>
      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="text-slate-500 font-medium">
            Empowering your life beyond the workplace.
          </p>
        </div>
